...
class Software(models.Model):
    ...
    externalauthors = models.CharField("External authors", max_length=255, help_text="Add any external authors (which are not in the system)",blank=True, null=True)
    publications = models.ManyToManyField(Publication, blank=True)
...
class Project(models.Model):
    ...
    externalmembers = models.CharField("External members", max_length=255, help_text="Add any external members (which are not in the system)",blank=True, null=True)
